...
VertexStruct main(float4 attrib[5] : ATTRIB, uint vid : SV_VertexID)
{
	...
	vresult.position.x = p.x * pc.slug_matrix[0].x + p.y * pc.slug_matrix[0].y + pc.slug_matrix[0].w;
	vresult.position.y = p.x * pc.slug_matrix[1].x + p.y * pc.slug_matrix[1].y + pc.slug_matrix[1].w;
	vresult.position.z = p.x * pc.slug_matrix[2].x + p.y * pc.slug_matrix[2].y + pc.slug_matrix[2].w;
	vresult.position.w = p.x * pc.slug_matrix[3].x + p.y * pc.slug_matrix[3].y + pc.slug_matrix[3].w;
